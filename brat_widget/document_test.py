...
class DocumentTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.just_entities_collection_configuration = {
            'entity_types': [{
                'type': 'Person',
        ...
        cls.entities_relations_and_events_collection_configuration = {
            "entity_types": [{
                "type": "Person",
                "labels": ["Person", "Per"],
                "bgColor": "#7fa2ff",
        ...
        cls.full_collection_configuration = {
            'description': None,
            'disambiguator_config': [],
            'entity_attribute_types': [{'unused': False,
                                        'values': [{'dashArray': u',', 'name': u'Individual',
                                                    'glyph': u'(I)'}],
                                        'labels': None,
                                        'type': u'Individual',
                                        'name': u'Individual'},
                                       {'unused': False, 'values': [{'position': u'left', 'dashArray': u',',
                                                                     'name': u'Name', 'glyph': u'(N)'},
                                                                    {'position': u'left', 'dashArray': u',',
                                                                     'name': u'Nominal', 'glyph': u'(n)'},
                                                                    {'position': u'left', 'dashArray': u',',
                                                                     'name': u'Other', 'glyph': u'(o)'}],
                                        'labels': None, 'type': u'Mention', 'name': u'Mention'}],
            'event_types': [{'borderColor': u'darken',
                             'normalizations': [],
                             'name': u'Life',
                             'labels': None,
                             'children': [{
                                 ...
                                 'type': u'Be-born',
                                 'fgColor': u'black'},
                                 {'borderColor': u'darken', 'normalizations': [], 'name': u'Marry',
                                  'arcs': [{'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                            'color': u'black', 'labels': [u'Person'], 'dashArray': u',',
                                            'type': u'Person-Arg', 'targets': [u'Person']},
                                           {'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                            'color': u'black', 'labels': [u'Place'], 'dashArray': u',',
                                            'type': u'Place-Arg', 'targets': [u'GPE']}],
                                  'labels': None, 'children': [], 'unused': False, 'bgColor': u'lightgreen',
                                  'attributes': ['Negation', u'Confidence'], 'type': u'Marry',
                                  'fgColor': u'black'},
                                 {'borderColor': u'darken', 'normalizations': [], 'name': u'Divorce',
                                  'arcs': [{'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                           ...
                                           {'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                            ...
                                            'type': u'Place-Arg', 'targets': [u'GPE']}],
                                  'labels': None, 'children': [], 'unused': False, 'bgColor': u'lightgreen',
                                  'attributes': ['Negation', u'Confidence'], 'type': u'Divorce',
                                  'fgColor': u'black'}, {'borderColor': u'darken', 'normalizations': [],
                                                         'name': u'Die', 'arcs': [{'labelArrow': u'none',
                                                                                   'arrowHead': u'triangle,5',
                                                                                   'color': u'black',
                                                                                   'labels': [u'Person'],
                                                                                   'dashArray': u',',
                                                                                  ...
                                                                                  {'labelArrow': u'none',
                                                                                   ...
                                                                                   'type': u'Place-Arg',
                                                                                   'targets': [u'GPE']}],
                                                         'labels': None, 'children': [], 'unused': False,
                                                         'bgColor': u'lightgreen',
                                                         'attributes': ['Negation', u'Confidence'],
                                                         'type': u'Die', 'fgColor': u'black'}],
                             'unused': True, 'bgColor': u'lightgreen', 'attributes': ['Negation', u'Confidence'],
                             'type': u'Life', 'fgColor': u'black'},
                            {'borderColor': u'darken',
                             'normalizations': [],
                             'name': u'Transaction',
                             'labels': None,
                             ...
                             'unused': True, 'bgColor': u'lightgreen', 'attributes': ['Negation', u'Confidence'],
                             'type': u'Transaction', 'fgColor': u'black'},
            ...
            'ui_names': {'entities': u'entities',
                         'events': u'events',
                         'relations': u'relations',
                         'attributes': u'attributes'},
            'normalization_config': [],
            'visual_options': {'arc_bundle': 'none', 'text_direction': 'ltr'},
            'unconfigured_types': [{'borderColor': u'darken',
                                    'labelArrow': u'none',
                                    'arrowHead': u'triangle,5',
                                    'name': u'Place',
                                    'color': u'black',
                                   ...
                                   {'borderColor': u'darken',
                                    ...
                                    'type': u'Reporter-Arg',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Artifact', 'color': u'black', 'labels': [u'Artifact'],
                                    'unused': True, 'bgColor': u'lightgreen', 'dashArray': u',',
                                    'type': u'Artifact-Arg', 'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Person', 'color': u'black', 'labels': [u'Person'], 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Person-Arg',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none',
                                    'arrowHead': u'triangle,5', 'name': u'Buyer', 'color': u'black',
                                    'labels': [u'Buyer'], 'unused': True, 'bgColor': u'lightgreen',
                                    'dashArray': u',', 'type': u'Buyer-Arg', 'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Seller', 'color': u'black', 'labels': [u'Seller'], 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Seller-Arg',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Recipient', 'color': u'black', 'labels': [u'Recipient'],
                                    'unused': True, 'bgColor': u'lightgreen', 'dashArray': u',',
                                    'type': u'Recipient-Arg', 'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Agent', 'color': u'black', 'labels': [u'Agent'], 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Agent-Arg',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Org', 'color': u'black', 'labels': [u'Org'], 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Org-Arg',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Event', 'color': u'black', 'labels': [u'Event'], 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Event-Arg',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Giver', 'color': u'black', 'labels': [u'Giver'], 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Giver-Arg',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Beneficiary', 'color': u'black', 'labels': [u'Beneficiary'],
                                    'unused': True, 'bgColor': u'lightgreen', 'dashArray': u',',
                                    'type': u'Beneficiary-Arg', 'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Money', 'color': u'black', 'labels': [u'Money'], 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Money-Arg',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Confidence', 'color': u'black', 'labels': None, 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Confidence',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Mention', 'color': u'black', 'labels': None, 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Mention',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': 'ARC_DEFAULT', 'color': u'black', 'labels': None, 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': 'ARC_DEFAULT',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': 'Negation', 'color': u'black', 'labels': None, 'unused': True,
                                    'bgColor': u'lightgreen', 'type': 'Negation', 'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': u'Individual', 'color': u'black', 'labels': None, 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': u'Individual',
                                    'fgColor': u'black'},
                                   {'borderColor': u'darken', 'labelArrow': u'none', 'arrowHead': u'triangle,5',
                                    'name': 'SPAN_DEFAULT', 'color': u'black', 'labels': None, 'unused': True,
                                    'bgColor': u'lightgreen', 'dashArray': u',', 'type': 'SPAN_DEFAULT',
                                    'fgColor': u'black'}],
            'messages': [],
            'event_attribute_types': [{'unused': False,
            ...
            'ner_taggers': [],
            'relation_types': [{'labelArrow': u'none', 'arrowHead': u'triangle,5', 'name': u'Located',
            ...
            'entity_types': [{'borderColor': u'darken', 'normalizations': [], 'name': u'Person',
                              'arcs': [{'labelArrow': u'none', 'arrowHead': u'triangle,5', 'color': u'black',
                                       ...
                                       {'labelArrow': u'none', 'arrowHead': u'none', 'color': u'black',
                                        ...
                                        'targets': [u'Person']}], 'labels': [u'Person'], 'children': [],
